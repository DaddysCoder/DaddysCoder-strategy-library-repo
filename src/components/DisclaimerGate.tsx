...
// Unmissable first-use disclaimer (brief §1/§6, reusing the FBA tool's
// consent/disclaimer gate pattern per §8). Because practitioner scope
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#111111]/70 p-4">
      ...
      >
        ...
        <div className="rounded-md border border-amber-300 bg-amber-50 dark:bg-amber-950 dark:border-amber-700 p-3 text-sm text-amber-900 dark:text-amber-100 space-y-2">
          <p className="font-semibold">This is a library to select from and personalise — not a generator.</p>
          <p>
            It surfaces evidence-based strategies from published sources. It never selects,
            ranks, or recommends a strategy for a specific case. You always choose which
            strategy fits, write the personalised activity and rationale yourself, and remain
            responsible for the clinical judgement behind that choice.
          </p>
          <p>
            Evidence summaries are honest, including null and mixed findings — a strategy
            appearing here is not an endorsement that it will work for a given person. Check
            the capacity considerations on any strategy before personalising it.
          </p>
          <p>
